  ...
  return Promise.all([
    ...
    knex('deals').then(function () {
      ...
      return knex('deals').insert([
        ...
        {merchant_id: 12, name: 'Cronut', description: 'Contains mustard' , quantity_available: faker.random.number({'min': 1,'max': 10}), image_path: `${path}nutella_cronut.jpg`, current_price: 2.00, end_date: "2019-08-01T20:00:00.000Z"},
        {merchant_id: 12, name: 'Veg Wrap', description: 'Contains mustard' , quantity_available: faker.random.number({'min': 1,'max': 10}), image_path: `${path}vegetable_wrap.jpg`, current_price: 3.00, end_date: "2019-08-01T20:00:00.000Z"},
        ...
        {merchant_id: 8, name: 'Salad', description: 'Chickpea Salad' , quantity_available: faker.random.number({'min': 1,'max': 10}), image_path: `${path}chickpea_salad.jpg`, current_price: 5.00, end_date: "2019-08-02T17:00:00.000Z"},
        ...
        {merchant_id: 14, name: 'Avocado Wrap', description: 'Vegetarian and gluten-free' , quantity_available: faker.random.number({'min': 1,'max': 10}), image_path: `${path}avocado_humus_wrap.jpeg`, current_price: 4.25, end_date: "2019-08-02T17:00:00.000Z"},
