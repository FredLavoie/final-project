...
<div className="container">
  <div className="row">
    ...
    <p className="center-align"><strong><a href="/login">Login here</a></strong></p>
    <p className="center-align"><strong><a href="/register">Sign up for a business account here</a></strong></p>
      <div className="row">
