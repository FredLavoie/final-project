    ...
    render() {
           ...
           const decimalPrice = parseFloat(Math.round(price * 100) / 100).toFixed(2);
            ...
            <tr>
                ...
                <td><i class="tiny material-icons" onClick={() => this.props.removeOneCartItem(this.props.shoppingcart)}>add</i>{this.props.shoppingcart.cart_quantity}<i class="tiny material-icons" onClick={() => this.props.addOneCartItem(this.props.shoppingcart)}>add</i></td>
